        ...
        <section className="py-24 overflow-x-clip">
            <div className="container relative">
                ...
                <div className="flex justify-center ">
                    ...
                    ✨$7.5M seed round raised</div>
                </div>
                <h1 className="text-6xl md:text-7xl lg:text-8xl font-medium text-center mt-6">Impactful design, created effortlessly</h1>
                <p className="text-center text-xl text-white/50 mt-8 max-w-2xl mx-auto">Design tools shouldn&apos;t slow you down. Layers combines powerful features with an intutiative interface
