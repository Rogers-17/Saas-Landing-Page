        ...
        <section className="py-24">
            <div className="container">
                ...
                <h2 className="text-6xl font-medium text-center mt-6 max-w-2xl mx-auto">
                    Where power meets <span  className="text-lime-400">
                        simplicity</span></h2>
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    <FeatureCard
                    title="Real Time Collaboration"
                    description="Work together seamlessly with conflict 
                    free editing"
                    ...
                    description="Engage your clients with protoptypes that appeals
                    to user actions"
                    className="md:col-span-2 lg:col-span-1">
                    <div className="aspect-video flex items-center justify-center">
                    ...
                    description="Powerful commands to help you create
                    design more quickly"
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map(feature => (
                        <div key={feature} className="bg-neutral-900 border-white/10 inline-flex px-3 md:px-5 py-1.5 md:py-2 rounded-2xl gap-3 items-center">
